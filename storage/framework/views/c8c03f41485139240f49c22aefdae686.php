...
<div class="container">
    ...
    <div class="form-section">
        ...
        <div class="register">
            Need Account? <a href="<?php echo e(route('register-form')); ?>">Register</a>
        </div>
    </div>
</div>
<?php /**PATH C:\xampp\htdocs\Projek Donasi (V2) - Copy\resources\views/auth/login.blade.php ENDPATH**/ ?>